...
class UserInput:
    def __init__(self, filename, vacancy_name, region):
...
def get_year_stat_mp(file_name, job_name, q, currencies, region):
...
def get_year_stats_mp():
    ...
    p = Process(target=get_year_stat_mp, args=(user_input.file_name, user_input.job_name, q, currencies.copy(), user_input.region))
    process.append(p)
    p.start()
...
def print_stats():
    print(f'Динамика уровня зарплат по годам для выбранного региона: {year_by_salary}')
    print(f'Динамика количества вакансий по годам для выбранного региона: {year_by_vac_num}')
    print(f'Динамика уровня зарплат по годам для выбранной профессии и выбранного региона: {year_by_salary_job}')
...
if __name__ == '__main__':
    ...
    user_input = UserInput(filename, profession, region)
    get_year_stats_mp()
    get_area_stats()
    print_stats()
