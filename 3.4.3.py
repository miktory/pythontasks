...
def get_stats():
    print(f'Динамика уровня зарплат по годам для выбранной профессии в указанном регионе: {st.years_salary_vac}')
    print(f'Динамика количества вакансий по годам для выбранной профессии в указанном регионе: {st.years_count_vac}')
